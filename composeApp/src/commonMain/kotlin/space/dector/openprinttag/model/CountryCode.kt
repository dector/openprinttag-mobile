...
enum class CountryCode(val code: String, val countryName: String) {
    ...
    companion object {
        /**
         * Finds a CountryCode by its two-letter code (case-insensitive).
         */
        ...
        /**
         * Finds a CountryCode by country name (case-insensitive, partial match).
         */
        fun fromCountryName(name: String): CountryCode? {
            return entries.find { it.countryName.equals(name, ignoreCase = true) }
        }
    }
}
